...
urlpatterns = [
    ...
    path('inventory/ledger/', views.stock_ledger, name='stock_ledger'),
    path('inventory/ledger/product/<int:product_id>/', views.product_stock_ledger, name='product_stock_ledger'),
