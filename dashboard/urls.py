...
urlpatterns = [
    ...
    path('orders/sync-steadfast/', views.sync_all_steadfast_orders, name='sync_all_steadfast_orders'),
    path('orders/sync-couriers/', views.sync_all_courier_orders, name='sync_all_courier_orders'),
    path('order/<str:order_number>/sync-steadfast/', views.sync_single_steadfast_order, name='sync_single_steadfast_order'),
    path('order/<str:order_number>/dispatch-steadfast/', views.dispatch_order_to_steadfast, name='dispatch_order_to_steadfast'),
