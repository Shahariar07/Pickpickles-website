    ...
    products_data = [
        {
            ...
            'gross_weight_grams': 850,
            'price_bdt': Decimal('350.00'),
            'original_price_bdt': Decimal('400.00'),
            'image': 'products/classic_dill_pickles.webp',
        ...
        },
        {
            ...
            'price_bdt': Decimal('350.00'),
            'original_price_bdt': Decimal('400.00'),
            'image': 'products/pickled_mixed_veggies.webp',
        ...
        },
        {
            ...
            'image': 'products/pickled_deshi_onions.webp',
        ...
        },
        {
            ...
            'image': 'products/pickled_green_peppers.webp',
        ...
        },
        {
            ...
            'original_price_bdt': Decimal('300.00'),
            'image': 'products/pickled_beetroot.webp',
        ...
        },
        {
            ...
            'category': cat_sweet,
            'tagline': 'Juicy Golden Pineapple Chunks with Crushed Chili, Peppercorns & Spiced Vinegar Brine!',
            'description': 'Handcrafted with fresh juicy golden pineapple chunks steeped in an artisanal spiced cane vinegar brine with crushed red chili flakes, whole yellow mustard seeds, black peppercorns, and fresh green chili slices. An irresistible harmony of sweet tropical fruit, sharp vinegar tang, and a spicy chili punch with zero heavy oils.',
            'flavor_profile': 'Sweet & Tangy, Tropical Warmth, Mild Chili Kick & Mustard Snap',
            'pairing_suggestions': 'BBQ & Grilled Chicken, Smash Burgers, Tacos, Fried Chicken, Shawarma, Cheesy Pizza & Fresh Green Salads',
            'cut_style': 'CHIPS',
            'spice_level': 'MEDIUM',
            'crunch_rating': 4,
            'jar_weight_grams': 600,
            'gross_weight_grams': 850,
            'price_bdt': Decimal('320.00'),
            'original_price_bdt': Decimal('360.00'),
            'image': 'products/pickled_pineapple.webp',
            'image_url': '/media/products/pickled_pineapple.webp',
            'is_featured': True,
            'is_in_stock': True,
            'stock_count': 50,
        ...
        },
        {
            ...
            'category': cat_sweet,
            'tagline': 'Juicy Long Slices of Golden Ripe Mango with Crushed Chili, Mustard & Spiced Vinegar Brine!',
            'description': 'Handcrafted with fresh juicy golden ripe mango long spears steeped in an artisanal spiced cane vinegar brine with crushed red chili flakes, whole yellow mustard seeds, black peppercorns, and aromatics. A mouth-watering harmony of sweet luscious mango, sharp tangy brine, and a spicy kick with zero heavy oils.',
            'flavor_profile': 'Sweet Tang, Juicy Mango Richness, Warm Mustard & Chili Kick',
            'pairing_suggestions': 'Kacchi Biryani, Beef Tehari, Bhuna Khichuri, Paratha, Grilled Meats, Smash Burgers & Daal-Bhat',
            'cut_style': 'SPEARS',
            'spice_level': 'MEDIUM',
            'crunch_rating': 4,
            'jar_weight_grams': 600,
            ...
            'price_bdt': Decimal('320.00'),
            'original_price_bdt': Decimal('360.00'),
            'image': 'products/pickled_mango.webp',
            'image_url': '/media/products/pickled_mango.webp',
            'is_featured': True,
            'is_in_stock': True,
            'stock_count': 50,
        ...
        },
        {
            ...
            'category': cat_relish,
            'tagline': 'Delicate Hard-Boiled Quail Eggs in Tangy Garlic, Mustard & Peppercorn Vinegar Brine!',
            'description': 'Handcrafted with tender, perfectly boiled bite-sized quail eggs steeped in an artisanal spiced cane vinegar brine infused with whole garlic cloves, yellow mustard seeds, black peppercorns, and crushed chili flakes. A savory gourmet delicacy rich in protein and bursting with zesty flavor with zero heavy oils.',
            'flavor_profile': 'Savory & Tangy, Garlic Infused, Whole Mustard & Peppercorn Punch',
            'pairing_suggestions': 'Salads, Charcuterie Boards, Ramen, Biryani, Tehari, Rice Bowls, Burgers & Gourmet Snacks',
            'cut_style': 'WHOLE',
            'spice_level': 'MILD',
            'crunch_rating': 5,
            'jar_weight_grams': 600,
            ...
            'original_price_bdt': Decimal('420.00'),
            'image': 'products/pickled_quail_eggs.webp',
            'image_url': '/media/products/pickled_quail_eggs.webp',
            'is_featured': True,
            'is_in_stock': True,
            'stock_count': 50,
        ...
        },
        {
            ...
            'category': cat_sweet,
            'tagline': 'Crisp, Sweet & Tangy Sliced Bell Peppers in Spiced Herb Vinegar Brine!',
            'description': 'Handcrafted with farm-fresh colorful bell peppers (capsicum) sliced and steeped in our artisanal sweet and tangy cane vinegar brine with whole garlic cloves, bay leaf, yellow mustard seeds, and black peppercorns. Delivers a vibrant, juicy, sweet-tangy crunch with zero heavy oils.',
            'flavor_profile': 'Sweet & Tangy, Vibrant Crunch, Garlic Infused, Mustard & Herb Snap',
            'pairing_suggestions': 'Smash Burgers, Sandwiches, Fried Chicken, Shawarma, Beef Tehari, Khichuri & Grilled Meats',
            'cut_style': 'CHIPS',
            'spice_level': 'MILD',
            'crunch_rating': 5,
            'jar_weight_grams': 600,
            ...
            'price_bdt': Decimal('350.00'),
            'original_price_bdt': Decimal('400.00'),
            'image': 'products/pickled_bell_peppers.webp',
            'image_url': '/media/products/pickled_bell_peppers.webp',
            'is_featured': True,
            'is_in_stock': True,
            'stock_count': 50,
        ...
        },
        {
            'name': 'Pickled Grapes',
            'category': cat_sweet,
            'tagline': 'Juicy Sweet, Tangy & Mildly Spiced Green Grapes with Crushed Chili Flakes!',
            'description': 'Handcrafted with plump, juicy whole green seedless grapes steeped in an artisanal spiced cane vinegar brine with crushed red chili flakes, yellow mustard seeds, cracked black pepper, and fragrant bay leaf. A crisp, zesty gourmet bite that bursts with sweet-tangy juice and a gentle spicy chili kick with zero heavy oils.',
            'flavor_profile': 'Juicy Sweet-Tangy Burst, Mild Chili Warmth, Mustard & Peppercorn Zest',
            'pairing_suggestions': 'Cheese Platters, Charcuterie, Smash Burgers, Roast Chicken, Biryani, Tehari & Gourmet Salads',
            'cut_style': 'WHOLE',
            'spice_level': 'MEDIUM',
            'crunch_rating': 4,
            'jar_weight_grams': 600,
            ...
            'price_bdt': Decimal('380.00'),
            'original_price_bdt': Decimal('420.00'),
            'image': 'products/pickled_grapes.webp',
            'image_url': '/media/products/pickled_grapes.webp',
            'is_featured': True,
            'is_in_stock': True,
            'stock_count': 50,
    ...
    for o_info in orders_data:
        ...
        for item in items_data:
            OrderItem.objects.create(
                ...
                jar_weight_grams=item['product'].jar_weight_grams or 600,
                gross_weight_grams=getattr(item['product'], 'gross_weight_grams', 850) or 850,
